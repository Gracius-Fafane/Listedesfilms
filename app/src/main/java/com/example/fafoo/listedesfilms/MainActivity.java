...
import com.example.fafoo.listedesfilms.models.MovieAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public final static String TAG = "ListedesfilmsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //initialize the adapter -- movies array cannot reinitialize after this point
        ...
        Log.d("MainActivity", "Views completed");
    ...
    private void getNowPlaying() {
        ...
        //execute and get request expecting JSON object response
    ...
    private void getConfiguration() {
        ...
        params.put(API_KEY_PARAM,  getString(R.string.api_key));
        //execute and get request expecting JSON object response
        Log.d("MainActivity", "Parameters OK");
        client.get(url, params, new JsonHttpResponseHandler(){

            @Override
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                logError("Failed gettint configuration", throwable, true);
            }
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    Log.d("MainActivity", "Config completed");
                    getNowPlaying();
                } catch (JSONException e) {
